...
poprig is a high performance Pop CPU miner, with official support for Linux and Windows.
...
## Usage
As an example of testnet: `./poprig -o stratum+tcp://test-pool.popchain.one:7200 -u pYqmPPPP5ee3oQBwvkD8hsQ9cjdwYhavL5.test -p x -t 2`
### Options
```    
...
* Run poprig as Administrator.
* Poprig automatically enables SeLockMemoryPrivilege for current user, but reboot or sign out still required. [Manual instruction](https://msdn.microsoft.com/en-gb/library/ms190730.aspx).
